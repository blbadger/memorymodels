...
frozen_encoder = LanguageMixer(n_vocab, decoder_dim, 16, tokenized_length, n_heads=heads, kernel=kernel).float().to(device)
...
output_dir = f'{checkpoint_root}/fineweb_frozen_retrievalenc_autoencoder\
_{encoder_dim}\
c{compression}\
_d{decoder_dim}\
_n{n_layers}\
